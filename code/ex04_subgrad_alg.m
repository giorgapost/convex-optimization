function [x, fx] = ex04_subgrad_alg(x0, f, subgrad, stepsize, f_opt, c)
%   EX04_SUBGRAD_ALG Implements the projected subgradient descent algorithm.
%
%   [X, FX] = EX04_SUBGRAD_ALG(X0, F, SUBGRAD, STEPSIZE, F_OPT, C)  Executes
